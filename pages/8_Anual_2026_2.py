...
# Listas de controle master para blindagem do código contra filtros de segurança
...
# --- DADOS CONSOLIDADOS DO QUADRIMESTRE 1 (Perfeitamente alinhados em 21 elementos) ---
...
# Lista de códigos correspondente aos 21 elementos originais do Q1
codigos_q1_lista = [80001, 80002, 80003, 80005, 80006, 80007, 80010, 80011, 80012, 80021, 80022, 80039, 80048, 80052, 80053, 80055, 80057, 80058, 80060, 80061, 80062]

df_q1 = pd.DataFrame({
    'COD': codigos_q1_lista,
    ...
    'Meta_Pos': list(map(float, meta_pos_q1_str)), 'Real_Pos': list(map(float, real_pos_q1_str)),
    'Meta_Cad': list(map(float, meta_cad_q1_str)), 'Real_Cad': list(map(float, real_cad_q1_str))
})

# --- DADOS CONSOLIDADOS DO QUADRIMESTRE 2 (Perfeitamente alinhados em 21 elementos) ---
...
real_fat_q2_str = ["248177.05", "1132333.32", "1316356.65", "1013469.49", "1306335.22", "1663758.70", "852723.95", "1023775.79", "2276592.50", "2618400.50", "68061.30", "88281.60", "961403.50", "824737.25", "1204014.20", "514863.07", "522850.55", "439628.79", "374437.30", "50216.50", "46956.50"]
...
meta_pos_q2_str = ["16.0", "586.0", "600.0", "512.0", "616.0", "551.0", "480.0", "320.0", "32.0", "490.0", "16.0", "170.0", "610.0", "400.0", "400.0", "50.0", "240.0", "65.0", "175.0", "54.0", "44.0"]
...
# 🔄 CONSOLIDAÇÃO ANUAL DINÂMICA VIA PANDAS POR COD (Soma absoluta Q1 + Q2)
...
# ✂️ Filtro corrigido para deixar apenas o Primeiro Nome de cada vendedor como String comum
...
# Cálculo de Atingimento (%) com base no acumulado por soma
