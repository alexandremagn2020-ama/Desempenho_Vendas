...
# Listas de controle blindadas contra o filtro de segurança
...
# --- BASE DE DADOS DO QUADRIMESTRE 1 ---
data_q1_raw = {
...
# --- BASE DE DADOS DO QUADRIMESTRE 2 ---
data_q2_raw = {
    'COD': [80001, 80002, 80003, 80005, 80006, 80007, 80010, 80011, 80012, 80021, 80022, 80039, 80048, 80052, 80053, 80055, 80058, 80060, 80061, 80062, 80063],
...
# 🔄 CONSOLIDAÇÃO DINÂMICA VIA PANDAS POR COD (Evita erros de alinhamento)
...
# Somas absolutas seguras tratando valores ausentes
...
# Média correta do Preço Médio (PM) do ano
