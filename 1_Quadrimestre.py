...
st.set_page_config(layout="wide", page_title="1º Quadrimestre")
st.markdown("<h2 style='text-align: center; color: #1E3A8A; font-weight: 700;'>🏆 DESEMPENHO — 1º QUADRIMESTRE</h2>", unsafe_allow_html=True)
st.write("---")
...
st.dataframe(df_ranking[['COD', 'Vendedor', 'Pontuacao_Total', 'P_Fat', 'P_Peso', 'P_PM', 'P_Pos', 'P_Cad']], use_container_width=True)
st.write("---")
